var startBtn = document.querySelector("#soundOn");
startBtn.addEventListener('click', ()=>{
  document.getElementById('btn').innerHTML = `<p></p>`
  var bootElement = document.querySelector('award-boot');
  bootElement.rebootSystem();
});
...
const sound = new Audio("./audio/boot.mp3");
